	...
	<div class="tengah" align="center">
		...
		<div class="konten" align="center">
			...
			<div class="maincontent">
				<form action="coba18maret.php" method="POST">
				  <div class="form-group">
				    <label for="exampleInputEmail1"><h6>Masukan baris<h6></label>
				    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nilai" required="">
				    <!-- <small id="emailHelp" class="form-text text-muted">Pembelian lebih dari 20 akan mendapatkan diskon 5%</small> -->
				  </div>
                  <!-- <div class="form-group">
				    <label for="exampleInputEmail1"><h6>Masukan kolom<h6></label>
				    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nilai2" required="">
				    <small id="emailHelp" class="form-text text-muted">Pembelian lebih dari 20 akan mendapatkan diskon 5%</small>
				  </div> -->
